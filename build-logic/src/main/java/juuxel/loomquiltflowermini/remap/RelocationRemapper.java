...
public final class RelocationRemapper extends Remapper {
    ...
    public static RelocationRemapper createQuiltflowerRelocator() {
        ...
        patterns.put("org/jetbrains/java/decompiler", "juuxel/loomquiltflowermini/impl/relocated/quiltflower");
        patterns.put("net/fabricmc/fernflower/api", "juuxel/loomquiltflowermini/impl/relocated/quiltflowerapi");
